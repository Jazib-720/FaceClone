...
public:
	...
	void displaylikeby()
	{
		...
		{
			if (like[i].getid() != NULL && like[i].getname() != NULL)
			{
	...
	void commentdisplay()
	{
		...
		{
			if (comment[i].getcommenttext() == NULL)
			{
				cout << "#" << i << endl;
			}
			if (comment[i].getcommenttext() != NULL)
